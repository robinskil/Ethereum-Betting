...
import JoinedBetsPage from "./JoinedBetsPage";
import { BetPage } from "./BetPage.js";
        ...
        <Router>
          <div className="container">
            ...
            <Route
              path="/CreateBet"
              component={() => {
                return <CreateBet web3={this.state.web3} />;
              }}
            />
            ...
            <Route
              path="/Login"
              component={() => {
                return <LoginIndex web3={this.state.web3} />;
              }}
            />
            <Route
              path="/JoinBet"
              component={() => {
                return <JoinBetPage web3={this.state.web3} />;
              }}
            />
            <Route
              path="/Register"
              component={() => {
                return <RegisterPage web3={this.state.web3} />;
              }}
            />
            <Route
              path="/Profile"
              component={() => {
                return <ProfilePage web3={this.state.web3} />;
              }}
            />
            <Route
              path="/ViewAllBets"
              component={() => {
                return <ViewAllBets web3={this.state.web3} />;
              }}
            />
            <Route
              path="/JoinedBets"
              component={() => {
                return <JoinedBetsPage web3={this.state.web3} />;
              }}
            />
            <Route
              path="/bet/:betId"
    ...
    return (
      <div class="jumbotron" style={{ padding: "2rem" }}>
        ...
        <div className="row justify-content-center">
          <img
            width="50%"
            src="https://en.bitcoinwiki.org/upload/en/images/7/7a/Ethereum11.png"
          />
        </div>
        <Link
