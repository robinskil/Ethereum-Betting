 ...
 */
export async function createWeatherBet(
  account,
  factoryContract,
  betAmount,
  maxParticipators,
  ...
  return await factoryContract.methods
    .createWeatherBet(betAmount, maxParticipators, open, friendsOnly, betLength)
    .send({ from: account });
}
 ...
 */
export async function createRandomNumberBet(
  account,
  factoryContract,
  betAmount,
  maxParticipators,
...
export async function createPuzzleBet(
  account,
  factoryContract,
  betAmount,
  maxParticipators,
  ...
  return await factoryContract.methods
    .createPuzzleBet(betAmount, maxParticipators, open, friendsOnly, betLength)
    .send({ from: account });
}
...
export async function getBet(contract, idx) {
  return await contract.methods.getSingleBet(idx).call();
}

export async function getSingleBet(contract) {
  return await contract.methods.getBet().call();
}
